...
<div className="alert alert-danger">The two passwords do not match, please try again</div>
<div className="form-group">
    ...
    <div className= "alert alert-warning">Username cannot be empty</div> <div className="form-group">
